    ...
    <div class="row-fluid">
        ...
        <div class="span4">
            <div class="right innerAll">
                <p>If you have any problems using <strong>Advance push for ANDROID installation wizards</strong> v1.0 or you have any suggestions or requests, please contact us. We appreciate all your feedback.</p>
