<head>
    <title>Advance push for ANDROID installation wizards V1.0</title>
...
<body class="">
    ...
    <div class="container-fluid fluid menu-left">
        ...
        <div class="navbar main hidden-print">
            ...
            <!-- Brand -->
            <a href="#" style="width:50%" class="appbrand pull-left"><span>Advance push for ANDROID installation wizards<span>V1.0</span></span></a>

            <!-- Menu Toggle Button -->
            <a href="#" class="appbrand pull-right"><span>Installation Agent <span>v1.0.0</span></span></a>
