          ...
          <div class="vd_content-section clearfix">
            <div class="vd_register-page">
              <div class="heading clearfix">
                <div class="logo">
                    <h2 class="mgbt-xs-5"><b>Advance PUSH</b></h2><br/>
                </div>
...
<!--                  <div id="register-success" class="alert alert-success" style="display:none;"><i class="fa fa-exclamation-circle fa-fw"></i> Registration confirmation has been sent to your email </div>
                  <div id="register-passerror" class="alert alert-danger" style="display:none;"><i class="fa fa-exclamation-circle fa-fw"></i> Your password and Confirm password are not same </div>-->
                   <?php if (Session::get('message') != '') { ?>
                    ...
                    <?php } ?>
                    <form class="form-horizontal"  action="{{url()}}/register" method="post" role="form" id="register-form">
                  ...
                  <div class="alert alert-success vd_hidden">
                    ...
                    <div class="alert alert-danger alert-danger3 vd_hidden">
                            <button type="button" class="close" data-dismiss="alert"
                                ...
                                Error!</strong> Email Already registered.
                        </div>
                    <div class="form-group">
                      <div class="col-md-6">
                        ...
                        <div class="vd_input-wrapper" id="first-name-input-wrapper"> <span class="menu-icon"> <i class="fa fa-user"></i> </span>
                          <input type="text" placeholder="John" class="required" required name="first_name" id="firstname">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="label-wrapper">
                        ...
                        <div class="vd_input-wrapper" id="last-name-input-wrapper"> <span class="menu-icon"> <i class="fa fa-user"></i> </span>
                          <input type="text" placeholder="Doe" class="required" required name="last_name" id="lastname">
                        </div>
                      </div>
                    </div>
<!--                    <div class="form-group">
                    ...
                    <div class="form-group ">
                      <div class="col-md-3">
                        ...
                        <div class="vd_input-wrapper" id="country-code-input-wrapper"> <span class="menu-icon"> <i class="fa fa-plus"></i> </span>
                          <input type="number" placeholder="Country" class="required" required  name="c_code" id="country">
                        </div>
                      </div>
                      <div class="col-md-9">
                        <div class="label-wrapper">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="vd_input-wrapper" id="confirm-password-input-wrapper"> <span class="menu-icon"> <i class="fa fa-lock"></i> </span>
                          <input type="password" placeholder="Password" class="required" required  name="c_password" id="confirmpass">
                        </div>
                      </div>
                    </div>
              ...
              <div class="register-panel text-center font-semibold"> Already Have an Account? <br/>
                <a href="{{url()}}/login">SIGN IN<span class="menu-icon"><i class="fa fa-angle-double-right fa-fw"></i></span></a>
              </div>
           <div class="register-panel text-center font-semibold">
                <a href="{{url()}}/">HOME<span class="menu-icon"><i class="fa fa-angle-double-right fa-fw"></i></span></a>
              </div>
            </div>
...
$(document).ready(function() {
	...
	var error_register_2 = $('.alert-danger:first', form_register_2);
	var success_register_2 = $('.alert-success', form_register_2);
	var warning_register_2 = $('.alert-warning', form_register_2);
        var error_register_3 = $('.alert-danger3', form_register_2);
