...
<div aria-hidden="true" role="dialog" tabindex="-1" class="modal fade modal_grp_add" style="display: none;z-index: 2147483648">
    <div class="modal-dialog" id="response">
        <div class="panel widget light-widget col-md-12">
            <div class="panel-body">
                <h3 class="mgbt-xs-20">Add Group</h3>
                <hr/>
                <form action="{{url()}}/admin/groups/add" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
                    <input type="hidden" name="page" id="" value="<?php echo empty($data['page']) ? 1 : $data['page'] ?>" />
                    <label>Name</label>
                    <input class="form-control" type="text" value="" id="title" name="name"/>
                    <hr>
                    <div class="row-fluid">
                        <button type="submit" id="btn-loading" class="btn btn-primary" data-loading-text="Loading...">Submit</button>
                    </div>
                </form>
            </div>
        </div>
                            ...
                            <form id="frmsubmit" enctype="multipart/form-data" method="post">
                                <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
										<div class="form-group">
										   <div id="checkbox_div" class="vd_radio radio-success">
											<input type="radio" name="device_type" id="optionsRadios3" value="android" checked>
											<label  for="optionsRadios3"> Android </label>
											<input type="radio" name="device_type" id="optionsRadios4" value="iphone">
											<label  for="optionsRadios4"> Iphone </label>
										  </div>
										</div>
										...
										<div id="iphone_div" class="form-group" style="display:none">
                                            <select class="form-control selectpicker span12" name="type" required="true" id="notytype">
                                                <option value="1">Simple Notification</option>
                                                <option value="3">Web Activity</option>
                                                <option value="4">News [saved in phone]</option>
                                    ...
                                    <form action="{{ action('Admincontroller@users_search') }}" method="get">
                                        ...
                                        <!--                                            <div class="col-md-3">
                                                                                        ...
                                                                                        <select class="form-control" name="app_type">
                                                                                            ...
                                                                                            <option <?php //echo!empty($data['app_type']) ? $data['app_type'] == 'PUSH_CAT_DELETE' ? 'selected' : '' : '';                                                                                                                                                                            ?> value="PUSH_CAT_DELETE">PUSH_CAT_DELETE</option>
                                                                                    <option <?php //echo!empty($data['app_type']) ? $data['app_type'] == 'PUSH_CAT' ? 'selected' : '' : '';                                                                                                                                                                            ?> value="PUSH_CAT">PUSH_CAT</option>
                                                                                </select>
                                                                            </div>-->
                                        <div class="col-md-2">
                                            <label>Status</label>
                                ...
                                <table id="example" class="table table-hover display">
                                    <thead>
										...
										<tr>
											...
											<td style="width:25%">Android {{ $user->device_os }}</td>
