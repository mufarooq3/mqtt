                    ...
                    <div class="container">
                        <div class="vd_top-nav vd_nav-width  ">
                            <div class="vd_panel-header">
                                <div class="logo">
                                    <a href="#" style="width:300px"><h3><b>Advance Push</b></h3></a>
                                </div>
                                <!-- logo -->
                                        ...
                                        <div class="vd_mega-menu pull-right">
                                            <ul class="mega-ul">
                                                <li id="top-menu-1" class="one-icon mega-li"> 
                                                    <a href="login" class="btn vd_btn vd_bg-yellow font-semibold">Login</a>	
                                                </li>
                                                <li id="top-menu-2" class="one-icon mega-li"> 
                                                    <a href="register" class="btn vd_btn  vd_bg-yellow font-semibold">Register</a>	
                                                </li>
                        ...
                        <div class="vd_content clearfix">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <h1 class="font-lg">Features of <span class="font-semibold vd_green">Advance push</span></h1>
                                </div>
                                <!-- col-md-12 --> 
                            </div>
                            <!-- row -->
                        ...
                        <div class="vd_content clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center mgbt-xs-20">
                                    ...
                                    <h2 class="font-semibold"> Advance push Screen Shot </h2><br/>
                                </div>
                                            ...
                                            <div class="vd_carousel-column">                  
                                                <div class="content-list content-large">
                                                    ...
                                                    <div class="menu-text"> <br/>
                                                        ...
                                                        <p class="vd_black font-semibold">CEO of Advance push, Inc.</p>
                                                    </div>
                                                </div>
                        ...
                        <div class="vd_content clearfix">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <br/>
                                    <br/>
                                    <div class="text-center"> <a class="btn vd_btn vd_btn-bevel vd_bg-red btn-lg font-semibold" href="register">Register</a> </div>
                                    <br/>
                                    <br/>
